...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Feb 2019 pada 18.22
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
--
-- Dumping data untuk tabel `jawaban_tes1`
--
...
--
-- Struktur dari tabel `jawaban_tes3`
--
...
--
-- Dumping data untuk tabel `jawaban_tes3`
--
...
--
-- Struktur dari tabel `jawaban_tes4`
--
...
--
-- Dumping data untuk tabel `jawaban_tes4`
--
...
--
-- Struktur dari tabel `jawaban_tes5`
--
...
--
-- Dumping data untuk tabel `jawaban_tes5`
--
...
(1, 'Ahmad Gojali', 'Ali', 'ali', 'ahmadgojali1309@gmail.com', 0, '20', '123456789', 'S-1', NULL);
...
--
-- Indexes for table `jawaban_tes3`
--
ALTER TABLE `jawaban_tes3`
 ADD PRIMARY KEY (`no`);

--
-- Indexes for table `jawaban_tes4`
--
ALTER TABLE `jawaban_tes4`
 ADD PRIMARY KEY (`no`);

--
-- Indexes for table `jawaban_tes5`
--
ALTER TABLE `jawaban_tes5`
 ADD PRIMARY KEY (`no`);
...
--
-- AUTO_INCREMENT for table `jawaban_tes3`
--
ALTER TABLE `jawaban_tes3`
MODIFY `no` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT for table `jawaban_tes4`
--
ALTER TABLE `jawaban_tes4`
MODIFY `no` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `jawaban_tes5`
--
ALTER TABLE `jawaban_tes5`
