              ...
              <div class="box box-solid">
                ...
                <?php
                  ...
                  $id_user   = $_GET['id_user'];
                   ...
                   $query = "SELECT user.*, jawaban_tes2.*, soal2.* from user, jawaban_tes2, soal2 where soal2.id = jawaban_tes2.id_soal and user.id = $id_user ";
                ...
                <div class="box-body">
                  <div class="text-center lead"><b>Jawaban Tes 2 Hubungan Kata</b></div><hr>
                  ...
                  <?php 
                      ...
                      $query2 = "SELECT user.*, jawaban_tes2.*, soal2.* from user, jawaban_tes2, soal2 where soal2.id = jawaban_tes2.id_soal and jawaban_tes2.jawaban = soal2.kunci_jawaban and user.id = $id_user ";
