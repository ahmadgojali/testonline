              ...
              <div class="box box-solid">
                ...
                <?php
                  ...
                  $id_user   = $_GET['id_user'];
                   ...
                   $query = "SELECT user.*, jawaban_tes4.*, soal4.* from user, jawaban_tes4, soal4 where soal4.id = jawaban_tes4.id_soal and user.id = $id_user ";
                ...
                <div class="box-body">
                  ...
                  <table class=" lead">                    
                   ...
                   <?php 
                      ...
                      $query2 = "SELECT user.*, jawaban_tes4.*, soal4.* from user, jawaban_tes4, soal4 where soal4.id = jawaban_tes4.id_soal and jawaban_tes4.jawaban = soal4.kunci_jawaban and user.id = $id_user ";
